...
namespace Luval.Blog.Web.Areas.Blog.Controllers
{
    ...
    public class AuthorController : Controller
    {
        ...
        private BlogAuthor CreateFromUser(ApplicationUser user)
        {
